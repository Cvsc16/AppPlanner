...
private const val EXPIRATION_DATE_TIME_KEY = "expiration_date_time"
private val EXPIRATION_DATETIME_PREFERENCES_KEY = longPreferencesKey(EXPIRATION_DATE_TIME_KEY)
private const val ADDITIONAL_EXPIRATION_DATE_TIME_MILLIS = 60_000 * 60
    ...
    override suspend fun insertToken(token: String) {
        applicationContext.authenticationPreferencesDataStore.edit { settings ->
            ...
            settings[EXPIRATION_DATETIME_PREFERENCES_KEY] =
                System.currentTimeMillis() + ADDITIONAL_EXPIRATION_DATE_TIME_MILLIS
        }
    }
}